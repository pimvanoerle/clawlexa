...
/* ST77916 init sequences for the Waveshare ESP32-S3-Touch-LCD-1.85C.
 * Generated verbatim from Waveshare's official ESP-IDF demo
 * (waveshareteam/ESP32-S3-Touch-LCD-1.85C, main/LCD_Driver/).
 *
 * FOOTGUN: this board ships with TWO panel variants, distinguished at
 * runtime by reading panel register 0x04. The generic component default
 * init drives neither correctly. See display.c for the detection logic.
 *   - st77916_init_default: register 0x04 == {00,7F,7F,7F}
 *   - st77916_init_new:     register 0x04 == {00,02,7F,7F} (adds INVON 0x21)
 */

#include "esp_lcd_st77916.h"

static const st77916_lcd_init_cmd_t st77916_init_default[] = {
...
static const st77916_lcd_init_cmd_t st77916_init_new[] = {
  {0xF0, (uint8_t []){0x28}, 1, 0},
  {0xF2, (uint8_t []){0x28}, 1, 0},
